                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="boder:none;" name="pregunta_1" id="pregunta_1" class="form-control pregunta-1" widht="50%" required />
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_2" id="pregunta_2" class="form-control pregunta-2" widht="50%" required />
                                                        <option selected="true" disabled="disabled">Seleccione una opción</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
                                                        <option value="3">NO APLICA</option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_8" id="pregunta_8" class="form-control pregunta-8" widht="50%" required />
                                                        <option selected="true" disabled="disabled">Seleccione una opción</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
                                                        <option value="3">NO APLICA</option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_3" id="pregunta_3" class="form-control pregunta-3" widht="50%" required />
                                                        <option selected="true" disabled="disabled">Seleccione una opción</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
                                                        <option value="3">NO APLICA</option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_9" id="pregunta_9" class="form-control pregunta-9" widht="50%" required />
                                                        <option selected="true" disabled="disabled">Seleccione una opción</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
                                                        <option value="3">NO APLICA</option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_4" id="pregunta_4" class="form-control pregunta-4" widht="50%" required />
                                                        <option selected="true" disabled="disabled">Seleccione una opción</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
                                                        <option value="3">NO APLICA</option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_5" id="pregunta_5" class="form-control pregunta-5" widht="50%" required />
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select style="border:none;" name="pregunta_6" id="pregunta_6" class="form-control pregunta-6" widht="50%" required />
                                                        <option selected="true" disabled="disabled">Seleccione una opción</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
                                                        <option value="3">NO APLICA</option>
