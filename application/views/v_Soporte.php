                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="evaluador" id="evaluador" autocomplete="off" placeholder="Escribe tu nombre" required />
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <select style="border:none;" name="sistema" id="sistema" class="form-control lista_sistemas" readonly required /></select>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label style="color: white;font-weight: Normal;">
                                <i style="color: #B6A264" class="fa fa-question-circle"></i>
                                &nbsp;1. ¿Nuestro equipo de Soporte resolvió tu solicitud/requerimiento?
                              </label>
                              <br>
                              <select style="border:none;" name="pregunta_1" id="pregunta_1" class="form-control pregunta-1" required />
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label style="color: white;font-weight: Normal;">
                                <i style="color: #B6A264" class="fa fa-question-circle"></i>
                                &nbsp;3. ¿Se resolvió tu problema en un tiempo razonable?
                              </label>
                              <select style="border:none;" name="pregunta_3" id="pregunta_3" class="form-control pregunta-3" required />
                                <option selected="true" disabled="disabled">Seleccione una opción</option>
                                <option value="1">SI</option>
                                <option value="2">NO</option>
                                <option value="3">NO APLICA</option>
