...
class Results_model extends CI_Model {
   ...
   function __construct(){
    ...
    function getProyectInformation($id_sistema){
        ...
        CASE r.respuesta_1 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_1,
        CASE r.respuesta_2 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_2,
        CASE r.respuesta_3 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_3,
        CASE r.respuesta_4 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_4,
        CASE r.respuesta_5 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_5,
        CASE r.respuesta_6 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_6,
        CASE r.respuesta_7 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_7,
        CASE r.respuesta_8 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_8,
        CASE r.respuesta_9 WHEN 1 THEN 'Sí' WHEN 3 THEN 'No Aplica' ELSE 'No' END respuesta_9,
    ...
    function getPromedio($id_sistema){
        ...
        CASE r.respuesta_1 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result1,
        CASE r.respuesta_2 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result2,
        CASE r.respuesta_3 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result3,
        CASE r.respuesta_4 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result4,
        CASE r.respuesta_5 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result5,
        CASE r.respuesta_6 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result6,
        CASE r.respuesta_7 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result7,
        CASE r.respuesta_8 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result8,
        CASE r.respuesta_9 WHEN 1 THEN 8.333 WHEN 2 THEN 4.165 WHEN 3 THEN 8.333 END result9,
