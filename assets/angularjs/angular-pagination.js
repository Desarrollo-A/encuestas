		...
		compile: function (element, attrs) {
			...
			return function (scope, element, atributos) {
				...
				var controls = angular.element('<div class="pagination-panel">'+
					...
					'ng-disabled="'+registro.getCurrentNotation()+'<=0"><i class="fas fa-caret-left"></i> Anterior</button>'+
					...
					'ng-disabled="'+registro.getCurrentNotation()+'>=('+registro.getDataLengthNotation()+'/'+registro.getSizeNotation()+')-1">Siguiente <i class="fas fa-caret-right"></i></button>'+
				'</div>');
